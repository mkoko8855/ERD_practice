...
public class JDBCInsert {
	...
	//사용할 객체의 변수를 try문 밖에서 미리 선언(finally에서도 사용해야 하니까)
	...
	try {
		 ...
		 */
		 ...
		 /*
		   # c. 물음표 채우기 (SQL문 완성하기)  ,  (그러나 물음표채울꺼없으면 생략가능)
		...
		// 예외 실행 여부와 상관 없이 항상 실행해야ㅇ하는 로직 > finally : 성공이든 실패든 무조건 close를 하기 위해 finally에다가 닫아줄것이다.
